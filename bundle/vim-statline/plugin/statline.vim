...
if g:statline_show_n_buffers
    set statusline=%2*%h\ %n/%{StatlineBufCount()}\ \|\ %<%*
...
if g:statline_show_encoding
    set statusline+=%2*\ \|\ %{&ff}%{g:statline_encoding_separator}%{strlen(&fenc)?&fenc:g:statline_no_encoding_string}%*
endif
